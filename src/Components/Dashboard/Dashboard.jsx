...
const Dashboard = () => {
    ...
    const handleGetUser = async () => {
        ...
        fetch(`https://ultimafinancesbackend.onrender.com/api/userdata/${id}`, {
            method: 'GET',
        })
    ...
    const handleLinkClick = () => {
      ...
      const handleLogOut = () =>{
        ...
        window.location.href = "https://ultimafinancs.vercel.app/"
      }
      const handleAdmin = () =>{
        nav(`UserUpdate`)
      }
                ...
                <div className={`DashboardWrapper ${showNav ? "active" : " "}`}>
                    ...
                    <div className={`DashboardMain ${showNav ? "active" : ""}`}>
                        ...
                        <div className="DashboardMainFooter">
                            <p>All Rights Reserved © Ultimafinancs 2024</p>
                        </div>
                    </div>
                </div>
            </div>
