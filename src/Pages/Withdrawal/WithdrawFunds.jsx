...
const WithdrawFunds = () => {
    ...
    const url = `https://ultimafinancesbackend.onrender.com/api/requestwithdrawcode/${id}`
    const urlll = `https://ultimafinancesbackend.onrender.com/api/withdrawal`
                ...
                <div className="WithdrawFundsContent">
                    <div className="WithdrawFundsContentBox">
                        ...
                        <div className="WithdrawFundsContentBox5">
                            <button onClick={sendWallet}>{isButtonDisabled ? "Request..." : " Complete Request" }</button>
                        </div>
                    </div>
                </div>
            </div>
