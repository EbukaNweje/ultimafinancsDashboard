...
const Payment = () => {
    ...
    const [state, setState] = useState({
        value: `${paymentname === "BITCOINP PAYMENT"? ("16mxmisJvejeYh5kuzBVnUMbmM1A8DwyX1"): paymentname === "ETHEREUM PAYMENT"? ("0x899862a58abe7fa3ad1d10fa03aee3f09fef7f46"): paymentname ==="USDT PAYMENT"? ("0x899862a58abe7fa3ad1d10fa03aee3f09fef7f46"): "Chosse a Payment Method"}`,
        copied: false,
      });

      const url = `https://ultimafinancesbackend.onrender.com/api/sendpayment/${id}`
